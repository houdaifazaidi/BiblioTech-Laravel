...
<div class="auth-wrapper">
    <div class="auth-card">
        ...
        <form method="POST" action="{{ route('register.post') }}">
            ...
            <button type="submit" class="btn btn-primary" style="width:100%;justify-content:center;padding:0.7rem;">Create Account</button>
        </form>

        <div style="text-align:center;margin-top:1.5rem;font-size:0.875rem;color:var(--muted);">
            Already have an account?
            <a href="{{ route('login') }}" style="color:var(--accent);text-decoration:none;font-weight:500;"> Sign In</a>
        </div>
    </div>
</div>
@endsection
